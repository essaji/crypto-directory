  ...
  return (
    <div className="exchange-card" onClick={() => navigate(`/exchange/${exchange.id}`)} data-testid="exchange-card">
      ...
      <div className="exchange-card__detail">
        ...
        <div className="exchange-card__country"><strong>Country: </strong> {exchange.country}</div>
        <div className="exchange-card__trust"><strong>Trust Score: </strong> {exchange.trust_score_rank}</div>
      </div>
    </div>
  )
}